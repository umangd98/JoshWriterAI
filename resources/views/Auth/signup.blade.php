                ...
                <div class="wrap d-md-flex" style="height: 600px; background-color: #ffffff;">
                    ...
                    <div class="login-wrap" style="margin-top: auto; margin-bottom: auto;">
                        ...
                        <a href="{{ route('social.oauth', 'google') }}">
                            <button type="submit" class="form-control submit px-3" style="background: #ffffff; color: black;  box-shadow: 0px 0px 5px 1px #aaaa;">
                                <img src="{{ asset('frontend/images/google.png') }}" alt="" style="height: 25px; margin-top: -2px;">Log
                                in with Google
                            </button>
                        </a>
                        ...
                        <form action="{{ route('RegisterUser') }}" method="POST" class="signin-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Enter your name" style="box-shadow: 0px 0px 5px 1px #aaaa; background: none;" value="{{ old('name') }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email" class="form-control" placeholder="Enter your e-mail" style="box-shadow: 0px 0px 5px 1px #aaaa; background: none;" value="{{ old('email') }}">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control" placeholder="Enter your password" style="box-shadow: 0px 0px 5px 1px #aaaa; background: none;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password_confirmation" class="form-control" placeholder="Re-Enter your password" style="box-shadow: 0px 0px 5px 1px #aaaa; background: none;">
